...
function Canvas1() {
  ...
  const [solid1, setSolid1] = useState({
    0: {animatingRotation: { x: { direction: true, amount: 0.9 } }},
    2: {animatingRotation: { x: { direction: false, amount: 1.5 }, z: { direction: false, amount: 1.5 } }},
    1: {animatingRotation: { x: { direction: true, amount: 0.9}, y: { direction: false, amount: 0.9} }},
  });
  const [solid2, setSolid2] = useState({
    0:{animatingRotation: { x: { direction: true, amount: 0.9 } }},
    2:{animatingRotation: { x: { direction: true, amount: 1.5 }, z: { direction: true, amount: 1.5 } }},
    1: {animatingRotation: { x: { direction: false, amount: 0.9}, y: { direction: true, amount: 0.9}, z: { direction: false, amount: 0.9} }},
  });
  const [solid3, setSolid3] = useState({
    0:{animatingRotation: { y: { direction: true, amount: 0.9 } }},
    2:{animatingRotation: { y: { direction: false, amount: 1.5 }, x: { direction: false, amount: 1.5 } }},
    1:{animatingRotation: { x: { direction: true, amount: 0.9 } , y: { direction: true, amount: 0.9 }, z: { direction: true, amount: 0.9 } }}
  });
  const [solid4, setSolid4] = useState({
    0:{animatingRotation: { z: { direction: true, amount: 0.9 } }},
    2:{animatingRotation: { x: { direction: false, amount: 1.5 }, z: { direction: false, amount: 1.5 } }},
    1:{animatingRotation: { z: { direction: true, amount: 0.9 }, y: { direction: false, amount: 0.9 }  }}
  });
  return (
    <div onClick={() => {
      setSolid1({
        animatingRotation: { x: { direction: true, amount: 0.9 } }
      })
